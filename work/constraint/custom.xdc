...
set_property PACKAGE_PIN H5 [get_ports {dataout[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {dataout[0]}]
set_property PACKAGE_PIN H4 [get_ports {dataout[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {dataout[1]}]
set_property PACKAGE_PIN H3 [get_ports {dataout[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {dataout[2]}]
set_property PACKAGE_PIN J3 [get_ports {stcp[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {stcp[0]}]
set_property PACKAGE_PIN J5 [get_ports {shcp[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {shcp[0]}]
set_property PACKAGE_PIN J4 [get_ports {timer[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {timer[0]}]
set_property PACKAGE_PIN K3 [get_ports {score_1[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {score_1[0]}]
set_property PACKAGE_PIN K2 [get_ports {score_2[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {score_2[0]}]
set_property PACKAGE_PIN C1 [get_ports {smash_button[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {smash_button[0]}]
set_property PULLDOWN true [get_ports {smash_button[0]}]
set_property PACKAGE_PIN B1 [get_ports {mode[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {mode[0]}]
set_property PULLDOWN true [get_ports {mode[0]}]
set_property PACKAGE_PIN D3 [get_ports {coin[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {coin[0]}]
set_property PULLDOWN true [get_ports {coin[0]}]
set_property PACKAGE_PIN E3 [get_ports {lever[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {lever[0]}]
set_property PULLDOWN true [get_ports {lever[0]}]
